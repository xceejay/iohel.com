...
**[Easy Jitsi](https://docs.easyjitsi.com)** and **[Awesome Jitsi](https://awesome-jitsi.com)** are my documentation and resource curation projects for the Jitsi video conferencing ecosystem. Combined 200+ stars. These started from deployment notes and grew because the Jitsi community needed better onboarding material.

**[REST API Starter](https://github.com/xceejay/rest-api-starter)** is a Go boilerplate with Chi, GORM, and Logrus. 20 stars. I use it as the starting point for every new Go backend project. It encodes opinions I've formed over multiple production deployments.

**[DonatePal](https://github.com/xceejay/donatepal)** is a full-stack donation management app in Go. Built it to explore server-side rendering in Go without a JavaScript build step. The entire thing compiles to a single binary.

**[Webserv](https://github.com/xceejay/webserv)** is an HTTP server in C. No frameworks, no libraries, just sockets and `recv()`. I built it to understand what Nginx does under the hood.
