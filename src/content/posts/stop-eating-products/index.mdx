...
For me that looked like instant noodles, bread, random snacks, and seed-oil junk as the default. Anything in a packet that wasn’t clearly real food was a regular guest. Tins of actual fish like tuna or sardines were the exception, not the problem. Real food showed up occasionally, not daily.
