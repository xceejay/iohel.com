...
I started early with Unix and Linux, experimenting with countless systems and even building my own. That curiosity still drives how I approach problems today.  
...
You can use a `<base>` tag in your HTML layout to simplify linking:  

```html
<base href="https://joelamoako.com/">
